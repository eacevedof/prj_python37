...
from ddd.mcp_outlook.domain.enums import McpServerNameEnum
from ddd.mcp_outlook.application import CallToolDto, ListToolsService, CallToolService


@final
class McpOutlookController:
    """MCP Server controller for Outlook mail operations."""
    ...
    def __init__(self) -> None:
        ...
        self._mcp_server = Server(McpServerNameEnum.OUTLOOK.value)
    ...
    def __register_services_as_handlers(self) -> None:
        ...
        async def list_tools() -> list[Tool]:
            try:
                ...
                self.__log_exception(
                    module="mcp_outlook_controller._register_handlers.list_tools",
                    base_exception=e
                )
                return []
        ...
        async def call_tool(event_name: str, payload_dict: dict) -> list[TextContent]:
            try:
                ...
                self.__log_exception(
                    module="mcp_outlook_controller._register_handlers.call_tool",
                    base_exception=e,
...
def start_mcp_or_fail() -> None:
    """Start the MCP server for Outlook mail operations."""
    try:
        asyncio.run(McpOutlookController.get_instance()())
    except BaseException as error:
        Logger.get_instance().write_error(
            module="mcp_outlook_controller.start_mcp",
            message=(
