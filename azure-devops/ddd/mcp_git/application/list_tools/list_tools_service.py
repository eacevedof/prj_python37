...
from ddd.mcp_git.application.list_tools.list_tools_result_dto import (
    ListToolsResultDto,
)
from ddd.mcp_git.infrastructure.repositories.tools_schema_reader_in_memory_repository import (
...
class ListToolsService:
    """Service that returns available MCP tools for Git operations."""
    ...
    async def __call__(self) -> ListToolsResultDto:
        tools = self._tools_schema_repository.get_all_git_tools()
