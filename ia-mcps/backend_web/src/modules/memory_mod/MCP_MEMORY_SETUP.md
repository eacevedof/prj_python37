...
El servidor MCP de memoria se publica por **HTTP** en `/mcp/memory` (antes era un proceso stdio
`python -m ddd.mcp_memory`, que ya no existe).

---

## ✅ Alta en Claude Code

Con `make dev` corriendo en la raíz del repo (`http://127.0.0.1:8010`):
