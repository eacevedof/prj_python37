...
from src.modules.emt_mcp.application.get_tool_schemas.get_tool_schemas_result_dto import (
...
class GetToolSchemasService:
    ...
    Hermano de `QueryEmtService` (`tools/call`): las dos operaciones del protocolo son
