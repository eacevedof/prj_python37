...
from src.modules.pdf_mcp.application.get_tool_schemas.get_tool_schemas_result_dto import (
...
class GetToolSchemasService:
    ...
    Hermano de `ConvertPdfService` (`tools/call`): las dos operaciones del protocolo son
