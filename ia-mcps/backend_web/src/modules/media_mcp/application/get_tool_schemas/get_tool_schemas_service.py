...
from src.modules.media_mcp.application.get_tool_schemas.get_tool_schemas_result_dto import (
...
class GetToolSchemasService:
    ...
    Hermano de `CreateMediaService` (`tools/call`): las dos operaciones del protocolo son
