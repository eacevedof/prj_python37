...
class AuthorizeUserDto:
    """Entrada del guardarraíl: quién llama, con qué contraseña y sobre quién.

    `target_user_tg_id` solo lo puede usar un admin; para un usuario normal
    sobra, porque siempre opera sobre lo suyo.
    """
