...
class VerifyFileSignatureResultDto:
    ...
    Immutable — the __init__ is auto-generated by @dataclass with typed parameters.
    Access fields directly: result.is_valid, result.actual_hash, etc.
    ...
    def from_primitives(cls, primitives: dict[str, Any]) -> Self:
        """Factory — construct from service computation result.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        Returns:
            Dict with all fields: is_valid, actual_hash, expected_hash, algorithm, file_path.
        """
        return {
