...
@final
class FileCheckerException(Exception):
    """Exceptions for the file_checker domain."""
    ...
    @classmethod
    def unexpected_custom(cls, message: str) -> "FileCheckerException":
        raise cls(f"{message}", ResponseCodeEnum.INTERNAL_SERVER_ERROR)

    @classmethod
    def bad_request_custom(cls, message: str) -> "FileCheckerException":
