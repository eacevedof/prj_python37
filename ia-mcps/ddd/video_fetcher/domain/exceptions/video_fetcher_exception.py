...
class VideoFetcherException(Exception):
    """Exceptions for the VideoFetcher domain."""
    ...
    @classmethod
    def bad_request_custom(cls, message: str) -> "VideoFetcherException":
        raise cls(f"{message}", ResponseCodeEnum.BAD_REQUEST)

    @classmethod
    def not_found_custom(cls, message: str) -> "VideoFetcherException":
        raise cls(f"{message}", ResponseCodeEnum.NOT_FOUND)

    @classmethod
    def unexpected_custom(cls, message: str) -> "VideoFetcherException":
