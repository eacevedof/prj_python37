...
def __config_asset_type(dom: Dom) -> None:
    ...
    dd = Dropdown(dom)
    # tipo de asset
    btn_xpath = AssetMaterialAttributesRepository.get_sel_asset_type_keyline()
    li_xpath = AssetMaterialAttributesRepository.get_sel_asset_type_keyline(ElementEnum.LI_XPATH)
