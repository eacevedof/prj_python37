...
class TacticalRequestsRepository:
    ...
    def get_sel_request_type(xpath: str = ElementEnum.BUTTON_XPATH) -> str:
        ...
        # new development
        return "/html/body/div[1]/main/div/div[1]/div[3]/section/div[2]/div/div[1]/div/div[2]/div[1]/div[1]/div/div/div/div[3]/ul/li[2]"
    ...
    @staticmethod
    def get_sel_asset_(xpath: str = ElementEnum.BUTTON_XPATH) -> str:
        if xpath == ElementEnum.BUTTON_XPATH:
            return ""
        return ""
