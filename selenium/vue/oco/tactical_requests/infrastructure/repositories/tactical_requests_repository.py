...
class TacticalRequestsRepository:
    ...
    def get_sel_asset(xpath: str = ElementEnum.BUTTON_XPATH) -> str:
        if xpath == ElementEnum.BUTTON_XPATH:
            return "/html/body/div[1]/main/div/div[1]/div[3]/section/div[2]/div/div[2]/div[1]/div/div/div[1]/div[2]/div/div/div/div[2]/button[2]"
        return "/html/body/div[1]/main/div/div[1]/div[3]/section/div[2]/div/div[2]/div[1]/div/div/div[1]/div[2]/div/div/div/div[3]/ul/li[1]"
