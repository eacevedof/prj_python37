...
@final
class SetTaskDoneController:
    """Controller de PATCH /api/tasks/{id}/done.
    ...
    _logger: Logger
    _set_task_done_service: SetTaskDoneService

    def __init__(self) -> None:
        self._logger = Logger.get_instance()
        self._set_task_done_service = SetTaskDoneService.get_instance()
