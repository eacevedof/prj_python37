...
from ddd.vocabulary.application.start_image_study_session.image_study_word_dto import (
    ImageStudyWordDto,
)
...
class StartImageStudySessionResultDto:
    ...
    rehidrata con ImageStudyWordDto.from_primitives(w).
    """
    ...
    def from_primitives(cls, primitives: dict[str, Any]) -> Self:
        ...
        words = [ImageStudyWordDto.from_primitives(w).to_dict() for w in words_raw]
