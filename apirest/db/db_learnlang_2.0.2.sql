...
/*Data for the table `app_sentence_times` */
...
insert  into `auth_user`(`id`,`password`,`last_login`,`is_superuser`,`username`,`first_name`,`last_name`,`email`,`is_staff`,`is_active`,`date_joined`) values (1,'pbkdf2_sha256$150000$kK228PsfZrvK$R4AJZ8eYfZaR6A/DInDuenmo60ruKhUh/PT4FqXo5Tw=','2019-04-22 19:51:46.576346',1,'sa','','','sa@theframework.es',1,1,'2019-04-20 22:13:58.619448');
...
insert  into `version_db`(`id`,`date`,`version`,`description`) values (1,'20190420162500','1.0.0','definicion');
