...
insert  into `auth_user`(`id`,`password`,`last_login`,`is_superuser`,`username`,`first_name`,`last_name`,`email`,`is_staff`,`is_active`,`date_joined`) values (1,'pbkdf2_sha256$150000$kK228PsfZrvK$R4AJZ8eYfZaR6A/DInDuenmo60ruKhUh/PT4FqXo5Tw=','2019-05-05 10:52:42.735207',1,'sa','','','sa@theframework.es',1,1,'2019-04-20 22:13:58.619448'),(2,'pbkdf2_sha256$150000$aWLw4dA2SH9V$g3nWr7rsH3Oo7IpqZWiA0wUmLoVrp/xfWyXBTF0VbsE=',NULL,1,'sa2','','','sa2@tfw.es',1,1,'2019-04-28 13:59:16.096768'),(3,'pbkdf2_sha256$150000$U394Fhz3vsWm$hirfJR89ZoMW0DzTTLu0YGA5gko9TSbuhd4oFjcvErA=','2019-05-18 09:44:48.875899',1,'sa3','','','sa3@tfw.es',1,1,'2019-04-28 14:21:05.951416');
...
insert  into `version_db`(`id`,`date`,`version`,`description`) values (1,'20190420162500','1.0.0','definicion'),(2,'20190409211700','2.0.3','cambio estructura de tablas'),(3,'20190511202600','2.0.4','creo campo date_validated'),(4,'201905181336','2.0.5','fix longitud description a 250');
