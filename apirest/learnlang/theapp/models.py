...
class AppArray(models.Model):
    ...
    update_platform = models.CharField(max_length=3, blank=True, null=True, default="adm",editable=False)
    update_user = models.CharField(max_length=15, blank=True, null=True, default="anonym",editable=False)
