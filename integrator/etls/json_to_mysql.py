...
pathmapping = core.get_path_mapping("elchalan.json")
...
dicsource = jsonhelper.get_dictbykey("id",mapping["source"]["context"]["id"])
...
jsonhelper.load_data()
# print(jsonhelper.get_data()); sys.exit()
dicconxcfg = jsonhelper.get_dictbykey("id",mapping["destiny"]["context"]["id"])
